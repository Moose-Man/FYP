...
# for ver_2 testing on test dataset - edit test_dataset parameters to change test path
...
image_save_path_train = r"C:\Users\user\Desktop\Uni_work\year_3\FYP\code\Pyramid_Pix2Pix\BCI_dataset\test_results\train_dataset\ver_3"
